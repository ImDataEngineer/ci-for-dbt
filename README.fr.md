...
> **Contexte.** Template pédagogique de [iamdataeng.com/projects/sedo.ci-for-dbt](https://iamdataeng.com/projects/sedo.ci-for-dbt). Fork, complète les TODO, push, reçois un verdict CI pédagogique. Pas un projet open source maintenu, un exercice évalué.
...
En alternative zéro-setup : ouvre le projet dans GitHub Codespaces via le bouton "Commencer" sur iamdataeng.com — tout sera installé automatiquement dans le devcontainer.
